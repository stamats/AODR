...
```{r}
corPlot(cor.mas5, minCor = 0.75, labels = pData(affyData)[,1], title = "MAS 5.0")
corPlot(cor.rma, minCor = 0.85, labels = pData(affyData)[,1], title = "RMA")
corPlot(cor.vsnrma, minCor = 0.80, labels = pData(affyData)[,1], title = "VSN-RMA")
corPlot(cor.gcrma, minCor = 0.85, labels = pData(affyData)[,1], title = "GC-RMA")
corPlot(cor.plier, minCor = 0.50, labels = pData(affyData)[,1], title = "PLIER")
```
...
corPlot(cor.rma, minCor = 0.7, labels = pData(affyData)[,1], title = "RMA")
corPlot(cor.gcrma, minCor = 0.78, labels = pData(affyData)[,1], title = "GC-RMA")
corPlot(cor.vsnrma, minCor = 0.78, labels = pData(affyData)[,1], title = "VSN-RMA")
```
