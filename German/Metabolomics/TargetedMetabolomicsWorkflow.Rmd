...
```{r}
library(MKinfer)
ind.na <- is.na(res$adj.p.value)
volcano(res$`difference in means`[!ind.na], pval = res$adj.p.value[!ind.na], 
        effect0 = 0, effect.low = -1, effect.high = 1, 
        alpha = 0.5, xlab = "log2-fold Change (log2-FC)",
...
Wir erhalten 23 signifikante Metaboliten. Unberücksichtigt sind bisher LOD und
